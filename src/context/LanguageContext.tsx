...
export const translations = {
  ja: {
    ...
    calgetcReqMethod: 'Cal-GETC (一般教養) 要件から選択',
    selectArea: 'エリア (Area) を選択',
    allCompletedInArea: 'このエリアの対象科目はすべて登録済みです！',
    ...
    igetcList: 'Cal-GETC (IGETC) リスト',
    igetcSubtitle: '一般教養要件（Cal-GETC）の取得状況と対象科目をチェックします。',
    igetcProgress: 'Cal-GETC 達成度',
    igetcPlanned: '計画中',
    igetcCompleted: '完了',
    igetcRemaining: '未履修',
    igetcStatus: 'ステータス',
    ...
    reqSubtitle: '志望大学および専攻に合致した、必要な一般教養科目(Cal-GETC)と専攻要件(Major Prep)の単位をチェックできます。',
    selectCollege: '所属コミカレ',
    selectUniv: '志望大学',
    selectMajor: '目標専攻',
    allTab: 'すべて',
    majorTab: '専攻要件',
    igetcTab: '一般教養 (Cal-GETC)',
    ...
    pdfUploadTitle: 'Assist.org PDFをアップロード',
    pdfUploadDesc: 'Assist.org からダウンロードした公式の「編入要件合意書 (Major Agreement)」のPDFをここにドロップするか、ファイルを選択してください。パーサーが授業コードを抽出し、完璧に正確な要件データに更新します。',
    parsingPdf: 'PDFデータを解析中...',
    parseSuccess: 'PDF要件を正常に解析しました！確認モーダルで保存してください。',
    parseFail: 'PDFの読み込みまたは解析に失敗しました。ファイルが破損していないかご確認ください。',
    customPdfActive: 'PDF解析によるカスタム要件を使用中',
    clearCustomPdf: 'デフォルトに戻す',
    confirmParsedTitle: '解析結果の確認・編集',
    saveParsedBtn: 'カスタム要件として保存',
    detectedCourses: '検出された授業一覧',
    univNameLabel: '志望大学名',
  ...
  en: {
    ...
    calgetcReqMethod: 'Select from Cal-GETC Requirements',
    selectArea: 'Select Area',
    allCompletedInArea: 'All courses in this area are already planned!',
    ...
    igetcList: 'Cal-GETC (IGETC) List',
    igetcSubtitle: 'Track your general education requirements (Cal-GETC) and check eligible courses.',
    igetcProgress: 'Cal-GETC Progress',
    ...
    reqSubtitle: 'Check general education (Cal-GETC) and major preparation requirements for your goal college.',
    selectCollege: 'Current College',
    selectUniv: 'Target University',
    selectMajor: 'Target Major',
    allTab: 'All',
    majorTab: 'Major Prep',
    igetcTab: 'GE (Cal-GETC)',
    ...
    pdfUploadTitle: 'Upload ASSIST.org PDF',
    pdfUploadDesc: 'Drag & drop the official ASSIST.org Major Agreement PDF here, or select a file. The parser will detect community college course codes and update this page with 100% accurate requirements.',
    parsingPdf: 'Parsing PDF data...',
    parseSuccess: 'PDF parsed successfully! Review and save in the modal.',
    parseFail: 'Failed to extract or parse PDF. Please verify the file is not corrupted.',
    customPdfActive: 'Using custom requirements parsed from PDF',
    clearCustomPdf: 'Reset to Defaults',
    confirmParsedTitle: 'Confirm Parsed Requirements',
    saveParsedBtn: 'Save Custom Requirements',
