...
export const mockRequirements: TransferRequirement[] = [
...

  {
    ...
    courses: [
      ...
      { code: 'CIS 41A', name: 'Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      { code: 'CIS 36A', name: 'Introduction to Computer Programming Using Java', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      ...
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHE 002A/002B Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHE 002A/002B Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry' } },
      ...
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MAT 021C/021D Series', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MAT 021C/021D Series', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus' } },
...

  {
    ...
    courses: [
      { code: 'CHEM 12A', name: 'Organic Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Organic Chemistry Series', satisfies: { code: 'CHE 118A', name: 'Organic Chemistry' } },
      { code: 'CHEM 12B', name: 'Organic Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Organic Chemistry Series', satisfies: { code: 'CHE 118B', name: 'Organic Chemistry' } },
      { code: 'CHEM 12C', name: 'Organic Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Organic Chemistry Series', satisfies: { code: 'CHE 118C', name: 'Organic Chemistry' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022A', name: 'Linear Algebra' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022B', name: 'Differential Equations' } },
      { code: 'ENGR 35', name: 'Statics', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 035', name: 'Statics' } },
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 017', name: 'Circuits I' } },
      ...
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHE 002C', name: 'General Chemistry' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry Series', satisfies: { code: 'CHE 002A', name: 'General Chemistry' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry Series', satisfies: { code: 'CHE 002B', name: 'General Chemistry' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009B', name: 'Classical Physics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009C', name: 'Classical Physics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009A', name: 'Classical Physics' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021A', name: 'Calculus' } },
...

  {
    ...
    courses: [
      ...
      { code: 'GEOL 10', name: 'Introductory Geology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'GEL 050, GEL 050L', name: 'Geology' } },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIS 002A', name: 'Introduction to Biology: Essentials of Life on Earth' } },
      { code: 'BIOL 6C', name: 'Ecology and Evolution', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIS 002B', name: 'Introduction to Biology: Principles of Ecology & Evolution' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'CIS 41A', name: 'Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      { code: 'CIS 36A', name: 'Introduction to Computer Programming Using Java', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009A', name: 'Classical Physics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009C', name: 'Classical Physics' } },
