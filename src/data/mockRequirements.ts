...
export const mockRequirements: TransferRequirement[] = [
  ...
  },
  {
    ...
    courses: [
      ...
      { code: 'PHYS 4B', name: 'Physics: Electricity & Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep' },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Waves, Fluids, and Optics', units: 6.0, type: 'Required', category: 'MajorPrep' },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1A & 1AL', name: 'General Biology and Lab' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1A & 1AL', name: 'General Biology and Lab' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1B', name: 'General Biology' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 6C', name: 'Evolution, Systematics and Ecology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1B', name: 'General Biology' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 1A', name: 'General Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 1B', name: 'General Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 1C', name: 'General Chemistry and Qualitative Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 12A', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3A & 3AL', name: 'Organic Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 12B', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3A & 3AL', name: 'Organic Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 12B', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3B & 3BL', name: 'Organic Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'CHEM 12C', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3B & 3BL', name: 'Organic Chemistry' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 40A', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 40B', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'ECE Science Elective' },
      { code: 'BIOL 40C', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'ECE Science Elective' },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYSICS 7C', name: 'Physics for Scientists and Engineers' }, orGroup: 'ECE Science Elective' },
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Recommended', category: 'MajorPrep', description: 'Introduction to circuit analysis, network theorems, and AC circuits.' },
      { code: 'ENGR 37L', name: 'Introduction to Circuit Analysis Laboratory', units: 2.0, type: 'Recommended', category: 'MajorPrep', description: 'Laboratory instruction for introduction to circuit analysis.' },
      { code: 'ENGL C1000', name: 'Academic Reading and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Statewide common course for academic reading, composition, and research.' },
      { code: 'ENGL C1001', name: 'Critical Thinking and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Statewide common course for critical reading, reasoning, and argumentative writing.' },
  ...
  },
  {
    ...
    courses: [
      ...
      { code: 'PHYS 4B', name: 'Physics: Electricity & Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep' },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Waves, Fluids, and Optics', units: 6.0, type: 'Required', category: 'MajorPrep' },
      { code: 'ASTR 10', name: 'Stellar Astronomy', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ASTRON 10', name: 'Stellar Astronomy' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1A & 1AL', name: 'General Biology and Lab' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1A & 1AL', name: 'General Biology and Lab' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1B', name: 'General Biology' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 6C', name: 'Evolution, Systematics and Ecology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIOLOGY 1B', name: 'General Biology' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 1A', name: 'General Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 1B', name: 'General Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 1C', name: 'General Chemistry and Qualitative Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 1A & 1AL & 1B', name: 'General Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 12A', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3A & 3AL', name: 'Organic Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 12B', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3A & 3AL', name: 'Organic Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 12B', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3B & 3BL', name: 'Organic Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'CHEM 12C', name: 'Organic Chemistry', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 3B & 3BL', name: 'Organic Chemistry' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 40A', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 40B', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'Aerospace Science Elective' },
      { code: 'BIOL 40C', name: 'Human Anatomy and Physiology', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MCELLBI 32 & 32L', name: 'Human Physiology' }, orGroup: 'Aerospace Science Elective' },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYSICS 7C', name: 'Physics for Scientists and Engineers' }, orGroup: 'Aerospace Science Elective' },
      { code: 'ENGL C1000', name: 'Academic Reading and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Statewide common course for academic reading, composition, and research.' },
      { code: 'ENGL C1001', name: 'Critical Thinking and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Statewide common course for critical reading, reasoning, and argumentative writing.' },
      { code: 'EWRT 1A', name: 'English Composition', units: 5.0, type: 'Required', category: 'IGETC' },
      { code: 'EWRT 2', name: 'Critical Thinking and Writing', units: 5.0, type: 'Required', category: 'IGETC' }
