...
export const mockRequirements: TransferRequirement[] = [
...

  {
    ...
    courses: [
      ...
      { code: 'ENGL C1000H', name: 'Academic Reading and Writing - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UCB R&C Area A' },
      ...
      { code: 'ENGL C1001H', name: 'Critical Thinking and Writing - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UCB R&C Area B' },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UCB R&C Area B' },
      { code: 'EWRT 1BH', name: 'Reading, Writing and Research - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UCB R&C Area B' },
      ...
      { code: 'ECON 1H', name: 'Principles of Macroeconomics - HONORS', units: 4.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Economics Requirement', satisfies: { code: 'ECON 1', name: 'Principles of Macroeconomics' } },
      ...
      { code: 'ECON 2H', name: 'Principles of Microeconomics - HONORS', units: 4.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Economics Requirement', satisfies: { code: 'ECON 2', name: 'Principles of Microeconomics' } },
      ...
      { code: 'MATH 1AH', name: 'Calculus I - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 1: MATH 16A/16B)', satisfies: { code: 'MATH 16A', name: 'Analytic Geometry and Calculus' } },
      ...
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 1: MATH 16A/16B)', satisfies: { code: 'MATH 16B', name: 'Analytic Geometry and Calculus' } },
      ...
      { code: 'MATH 1AH', name: 'Calculus I - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 2: MATH 51/52)', satisfies: { code: 'MATH 51', name: 'Calculus I' } },
      ...
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 2: MATH 51/52)', satisfies: { code: 'MATH 51', name: 'Calculus I' } },
      ...
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 2: MATH 51/52)', satisfies: { code: 'MATH 52', name: 'Calculus II' } },
      ...
      { code: 'MATH 1CH', name: 'Calculus III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UCB Math Requirement (Path 2: MATH 51/52)', satisfies: { code: 'MATH 52', name: 'Calculus II' } },
      ...
      { code: 'ARTS 2H', name: 'History of Art: Native Arts of Mesoamerica and the Andes', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 10H', name: 'Introduction to Fiction - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 17H', name: 'Introduction to Shakespeare - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 46AH', name: 'Major British Writers (Medieval and Renaissance) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'ELIT 46B', name: 'Major British Writers (Neo-Classical and Romantic)', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'ELIT 46BH', name: 'Major British Writers (Neo-Classical and Romantic) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'ELIT 46C', name: 'Major British Writers (Victorian and Modern)', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'ELIT 46CH', name: 'Major British Writers (Victorian and Modern) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 48AH', name: 'Major American Writers (Colonial to Romantic, 1620-1865) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 48BH', name: 'Major American Writers (The Advent of Realism, 1865-1914) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ELIT 48CH', name: 'Major American Writers (The Modern Age, 1914-the Present) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 1', name: 'Introduction to Cinematic Arts', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 1H', name: 'Introduction to Cinematic Arts - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2A', name: 'History of the Cinema (1895-1950)', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2AH', name: 'History of Cinema (1895-1950) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2AW', name: 'History of Cinema (1895-1950)', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2AWH', name: 'History of Cinema (1895-1950) - HONORS', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2B', name: 'History of Cinema (1950-Present)', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2BH', name: 'History of Cinema (1950-Present) - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2BW', name: 'History of Cinema (1950-Present)', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2BWH', name: 'History of Cinema (1950-Present) - HONORS', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2C', name: 'Contemporary World Cinema', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2CH', name: 'Contemporary World Cinema - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2CW', name: 'Contemporary World Cinema', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'F/TV 2CWH', name: 'Contemporary World Cinema - HONORS', units: 4.5, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ANTH 1H', name: 'Physical Anthropology - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'BIOL 6AH', name: 'Form and Function in the Biological World - HONORS', units: 6.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'BIOL 6CH', name: 'Ecology and Evolution - HONORS', units: 6.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'BIOL 10', name: 'Introductory Biology', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'BIOL 10H', name: 'Introductory Biology - HONORS', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HIST 3AH', name: 'World History from Prehistory to 750 CE - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 3B', name: 'World History from 750 to 1750 CE', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 3BH', name: 'World History from 750 to 1750 CE - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 3C', name: 'World History from 1750 CE to the Present', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 3CH', name: 'World History from 1750 CE to the Present - Honors', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HIST 6AH', name: 'History of Western Civilization: Pre-History to 750 C.E. - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 6B', name: 'History of Western Civilization: 750 C.E. to 1750 C.E.', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 6BH', name: 'History of Western Civilization: 750 C.E. to 1750 C.E. - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 6C', name: 'History of Western Civilization: 1750 C.E. to Present', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 6CH', name: 'History of Western Civilization: 1750 C.E. to Present - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HIST 9H', name: 'Women in American History - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 10', name: 'History of California', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 10H', name: 'History of California - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HIST 17AH', name: 'History of the United States to Early National Era - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 17B', name: 'History of the United States from 1800 to 1900', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'HIST 17BH', name: 'History of the United States from 1800 to 1900 - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HIST 17CH', name: 'History of the United States From 1900 to the Present - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HUMI 1H', name: 'Creative Minds - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HUMI 9H', name: 'Introduction to Comparative Religion - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HUMI 18H', name: 'History as Mystery: A Critique of Western Perspectives in a Global Context - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ICS 17H', name: 'Critical Consciousness and Social Change - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'PHIL 8H', name: 'Ethics - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'CHEM 1AH', name: 'General Chemistry I - HONORS', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'CHEM 1BH', name: 'General Chemistry II - HONORS', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      { code: 'CHEM 1CH', name: 'General Chemistry III - HONORS', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ANTH 2H', name: 'Cultural Anthropology - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'ICS 27H', name: 'Grassroots Democracy: Leadership and Power - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'HUMA 10H', name: 'Human Sexuality - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'POLS C1000H', name: 'American Government and Politics - HONORS', units: 5.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'POLI 17H', name: 'Grassroots Democracy: Leadership and Power - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
      ...
      { code: 'WMST 9H', name: 'Women in American History - HONORS', units: 4.0, type: 'Highly Recommended', category: 'IGETC' },
