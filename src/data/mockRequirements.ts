...
export const mockRequirements: TransferRequirement[] = [
...

  {
    ...
    courses: [
      ...
      { code: 'COMM C1000', name: 'Introduction to Public Speaking', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CMN 001', name: 'Introduction to Public Speaking' } },
      { code: 'ELIT 39', name: 'Contemporary Literature', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'COM 004', name: 'Major Works of the Contemporary World' } },
      { code: 'EWRT 1C', name: 'Literature and Composition', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'English Literature Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'English Literature Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      { code: 'NAIS 15', name: 'Ethnic Studies and Native American Literature', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'NAS 005', name: 'Introduction to Native American Literature' } },
      { code: 'COMM 9', name: 'Argumentation: Analysis of Oral and Written Communication', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Academic Literacies Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'ENGL C1000', name: 'Academic Reading and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Academic Literacies Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Academic Literacies Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
...

  {
    ...
    courses: [
      ...
      { code: 'ENGR 35', name: 'Statics', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 035', name: 'Statics' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHE 002C', name: 'General Chemistry' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHE 002A/B Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHE 002A/B Series', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009B', name: 'Classical Physics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009A', name: 'Classical Physics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009C', name: 'Classical Physics' } },
      { code: 'COMM C1000', name: 'Introduction to Public Speaking', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CMN 001', name: 'Introduction to Public Speaking' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021B', name: 'Calculus' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021A', name: 'Calculus' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MAT 021C/D Series', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus Series' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MAT 021C/D Series', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus Series' } },
      { code: 'EWRT 1C', name: 'Literature and Composition', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'ENL 003 Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'ENL 003 Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      { code: 'COMM 9', name: 'Argumentation: Analysis of Oral and Written Communication', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'ENGL C1000', name: 'Academic Reading and Writing', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      ...
      { code: 'CIS 26B', name: 'Advanced C Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 26A', name: 'C as a Second Programming Language', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 22B', name: 'Intermediate Programming Methodologies in C++', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 35A', name: 'Java Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 27', name: 'Programming in C++ for C/Java Programmers', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 36A', name: 'Introduction to Computer Programming Using Java', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
      { code: 'CIS 22A', name: 'Beginning Programming Methodologies in C++', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'ECS 036A Selection', satisfies: { code: 'ECS 036A', name: 'Programming & Problem Solving' } },
...

  {
    ...
    courses: [
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021A', name: 'Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021B', name: 'Calculus' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus III and IV Sequence', satisfies: { code: 'MAT 021C/021D', name: 'Calculus Series' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus III and IV Sequence', satisfies: { code: 'MAT 021C/021D', name: 'Calculus Series' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022A', name: 'Linear Algebra' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022B', name: 'Differential Equations' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009B', name: 'Classical Physics' } },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009D', name: 'Modern Physics' } },
      ...
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 017', name: 'Circuits I' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHE 002C', name: 'General Chemistry' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry I/II Sequence', satisfies: { code: 'CHE 002A/002B', name: 'General Chemistry Series' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'General Chemistry I/II Sequence', satisfies: { code: 'CHE 002A/002B', name: 'General Chemistry Series' } },
      { code: 'CIS 41A', name: 'Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      { code: 'CIS 36A', name: 'Introduction to Computer Programming Using Java', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Programming Selection', satisfies: { code: 'ECS 032A', name: 'Introduction to Programming' } },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'BIS 002A', name: 'Introduction to Biology: Essentials of Life on Earth' } },
      { code: 'EWRT 1C', name: 'Literature and Composition', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Literature Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
...

  {
    ...
    courses: [
      ...
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021A', name: 'Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021B', name: 'Calculus' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus Series Selection', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus Series' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus Series Selection', satisfies: { code: 'MAT 021C, MAT 021D', name: 'Calculus Series' } },
      { code: 'COMM C1000', name: 'Introduction to Public Speaking', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CMN 001', name: 'Introduction to Public Speaking' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Chemistry Series Selection', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Chemistry Series Selection', satisfies: { code: 'CHE 002A, CHE 002B', name: 'General Chemistry Series' } },
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 017', name: 'Circuits I' } },
      { code: 'NAIS 15', name: 'Ethnic Studies and Native American Literature', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'NAS 005', name: 'Introduction to Native American Literature' } },
      { code: 'EWRT 1C', name: 'Literature and Composition', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Literature Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Literature Selection', satisfies: { code: 'ENL 003', name: 'Introduction to Literature' } },
      ...
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009A', name: 'Classical Physics' } },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHY 009D', name: 'Modern Physics' } },
      { code: 'CIS 36B', name: 'Intermediate Problem Solving in Java', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Software Development Selection', satisfies: { code: 'ECS 036B', name: 'Software Development & Object-Oriented Programming in C++' } },
      { code: 'CIS 35A', name: 'Java Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Software Development Selection', satisfies: { code: 'ECS 036B', name: 'Software Development & Object-Oriented Programming in C++' } },
      { code: 'CIS 22B', name: 'Intermediate Programming Methodologies in C++', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Software Development Selection', satisfies: { code: 'ECS 036B', name: 'Software Development & Object-Oriented Programming in C++' } },
      { code: 'CIS 29', name: 'Advanced C++ Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Software Development Selection', satisfies: { code: 'ECS 036B', name: 'Software Development & Object-Oriented Programming in C++' } },
      { code: 'ENGR 35', name: 'Statics', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 035', name: 'Statics' } },
      { code: 'ACCT 1A', name: 'Financial Accounting I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Accounting Selection', satisfies: { code: 'MGT 011A', name: 'Elementary Accounting' } },
      { code: 'ACCT 1B', name: 'Financial Accounting II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Accounting Selection', satisfies: { code: 'MGT 011A', name: 'Elementary Accounting' } },
      { code: 'ACCT 1C', name: 'Managerial Accounting', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MGT 011B', name: 'Elementary Accounting' } }
    ]
  },

  {
    ...
    courses: [
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022A', name: 'Linear Algebra' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 022B', name: 'Differential Equations' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 1A & 1B', satisfies: { code: 'CHE 002A', name: 'General Chemistry' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 1A & 1B', satisfies: { code: 'CHE 002B', name: 'General Chemistry' } },
      { code: 'ENGR 35', name: 'Statics', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 035', name: 'Statics' } },
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'ENG 017', name: 'Circuits I' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021A', name: 'Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MAT 021B', name: 'Calculus' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 1C & 1D', satisfies: { code: 'MAT 021C', name: 'Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 1C & 1D', satisfies: { code: 'MAT 021D', name: 'Calculus' } },
      { code: 'COMM 9', name: 'Argumentation', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'ENGL C1000', name: 'Academic Reading and Writing', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'EWRT 1B', name: 'Reading, Writing and Research', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'ESL 5', name: 'Advanced Composition and Reading', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'UWP 001 Selection', satisfies: { code: 'UWP 001', name: 'Introduction to Academic Literacies' } },
      { code: 'NAIS 15', name: 'Ethnic Studies and Native American Literature', units: 4.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'NAS 005', name: 'Introduction to Native American Literature' } },
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'MAE: Mechanical Engineering B.S.',
    courses: [
      { code: 'CIS 22A', name: 'Beginning Programming Methodologies in C++', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 41A', name: 'Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 40', name: 'Introduction to Programming in Python', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 35A', name: 'Java Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 41B', name: 'Advanced Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      ...
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Sequence', satisfies: { code: 'MATH 20C/20E', name: 'Calculus and Analytic Geometry for Science and Engineering / Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Sequence', satisfies: { code: 'MATH 20C/20E', name: 'Calculus and Analytic Geometry for Science and Engineering / Vector Calculus' } },
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Chemical and Nano Engineering: Chemical Engineering B.S.',
    courses: [
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 7L Selection', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 7L Selection', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      ...
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6C', name: 'General Chemistry III' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/E Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/E Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20E Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20E Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } }
    ]
  },

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Structural Engineering with a Specialization in Geotechnical Engineering B.S.',
    courses: [
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      ...
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Group', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Group', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Group', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Group', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } }
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'MAE: Aerospace Engineering B.S.',
    courses: [
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Selection', satisfies: { code: 'MATH 20C/20E', name: 'Calculus and Analytic Geometry/Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C/20E Selection', satisfies: { code: 'MATH 20C/20E', name: 'Calculus and Analytic Geometry/Vector Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'CIS 22A', name: 'Beginning Programming Methodologies in C++', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 MATLAB Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 41A', name: 'Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 MATLAB Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 40', name: 'Introduction to Programming in Python', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 MATLAB Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Bioengineering: BioSystems B.S.',
    courses: [
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Linear Algebra Selection', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Differential Equations Selection', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Vector Calculus and Multivariable Calculus Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Vector Calculus and Multivariable Calculus Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2BL', name: 'Physics Laboratory - Mechanics' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6B', name: 'General Chemistry II' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } }
    ]
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Structural Engineering with a Specialization in Civil Structures B.S.',
    courses: [
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'General Chemistry I', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'PHYS 2CL and 2B requirement', satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'PHYS 2CL and 2B requirement', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'PHYS 2A and 2BL requirement', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'PHYS 2A and 2BL requirement', satisfies: { code: 'PHYS 2BL', name: 'Physics Laboratory - Mechanics' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C and 20E selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C and 20E selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C and 20E selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'MATH 20C and 20E selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Structural Engineering B.S.',
    courses: [
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      ...
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2BL', name: 'Physics Laboratory - Mechanics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus/Vector Sequence', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus/Vector Sequence', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus/Vector Sequence', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus/Vector Sequence', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } }
...

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Structural Engineering with a Specialization in Structural Health Monitoring/Non-destructive Evaluation B.S.',
    courses: [
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      ...
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, satisfies: { code: 'PHYS 2BL', name: 'Physics Laboratory - Mechanics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', isOverlap: true, satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus 20C/20E', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus 20C/20E', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus 20C/20E', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', isOverlap: true, orGroup: 'Calculus 20C/20E', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } }
...

  {
    ...
    courses: [
      ...
      { code: 'CIS 35A', name: 'Java Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'CIS 41B', name: 'Advanced Python Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'MAE 8 Programming Selection', satisfies: { code: 'MAE 8', name: 'MATLAB Programming for Engineering Analysis' } },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1 Biological Sequence', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1 Biological Sequence', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'BIOL 6C', name: 'Ecology and Evolution', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1 Biological Sequence', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2BL', name: 'Physics Laboratory - Mechanics' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2CL', name: 'Physics Laboratory - Electricity and Magnetism' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Vector Calculus Sequence', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Vector Calculus Sequence', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus 20C Sequence', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus 20C Sequence', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Chem Lab Sequence', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Chem Lab Sequence', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6B', name: 'General Chemistry II' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } }
    ]
  },

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'ECE: Electrical Engineering B.S.',
    courses: [
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 2', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', orGroup: 'Calculus and Analytic Geometry Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', orGroup: 'Calculus and Analytic Geometry Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 2', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', orGroup: 'Vector Calculus Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', orGroup: 'Vector Calculus Selection', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', description: 'Option 2', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', description: 'Option 1', satisfies: { code: 'PHYS 2D', name: 'Physics - Relativity and Quantum Physics' } }
    ]
  },

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'ECE: Computer Engineering B.S.',
    courses: [
      { code: 'CIS 36B', name: 'Intermediate Problem Solving in Java', units: 4.5, type: 'Required', category: 'MajorPrep', description: 'Option 1 for CSE 11', orGroup: 'CSE 11 Selection', satisfies: { code: 'CSE 11', name: 'Introduction to Programming and Computational Problem Solving - Accelerated Pace' } },
      { code: 'CIS 35A', name: 'Java Programming', units: 4.5, type: 'Required', category: 'MajorPrep', description: 'Option 2 for CSE 11', orGroup: 'CSE 11 Selection', satisfies: { code: 'CSE 11', name: 'Introduction to Programming and Computational Problem Solving - Accelerated Pace' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C Selection', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2A', name: 'Physics - Mechanics' } },
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'CIS 22C', name: 'Data Abstraction and Structures', units: 4.5, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CSE 12', name: 'Basic Data Structures and Object-Oriented Design' } },
      { code: 'CIS 26B', name: 'Advanced C Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'CSE 30 Selection', satisfies: { code: 'CSE 30', name: 'Computer Organization and Systems Programming' } },
      { code: 'CIS 21JA', name: 'Introduction to x86 Processor Assembly Language and Computer Architecture', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'CSE 30 Selection', satisfies: { code: 'CSE 30', name: 'Computer Organization and Systems Programming' } },
      { code: 'CIS 21JB', name: 'Advanced x86 Processor Assembly Programming', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'CSE 30 Selection', satisfies: { code: 'CSE 30', name: 'Computer Organization and Systems Programming' } }
    ]
  },

  {
    fromCollege: 'De Anza College',
    toUniversity: 'UC San Diego',
    major: 'Chemical and Nano Engineering: NanoEngineering B.S.',
    courses: [
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 7L', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'CHEM 7L', satisfies: { code: 'CHEM 7L', name: 'Introductory Inorganic Chemistry Laboratory' } },
      { code: 'CHEM 1A', name: 'General Chemistry I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6A', name: 'General Chemistry I' } },
      { code: 'CHEM 1C', name: 'General Chemistry III', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6C', name: 'General Chemistry III' } },
      { code: 'CHEM 1B', name: 'General Chemistry II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'CHEM 6B', name: 'General Chemistry II' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2B', name: 'Physics - Electricity and Magnetism' } },
      ...
      { code: 'PHYS 4C', name: 'Physics for Scientists and Engineers: Fluids, Waves, Optics and Thermodynamics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2C', name: 'Physics - Fluids, Waves, Thermodynamics, and Optics' } },
      { code: 'PHYS 4D', name: 'Physics for Scientists and Engineers: Modern Physics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYS 2D', name: 'Physics - Relativity and Quantum Physics' } },
      { code: 'BIOL 6A', name: 'Form and Function in the Biological World', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'BIOL 6B', name: 'Cell and Molecular Biology', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'BIOL 6C', name: 'Ecology and Evolution', units: 6.0, type: 'Required', category: 'MajorPrep', orGroup: 'BILD 1', satisfies: { code: 'BILD 1', name: 'The Cell' } },
      { code: 'MATH 1A', name: 'Calculus I', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20A', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 2A', name: 'Differential Equations', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20D', name: 'Introduction to Differential Equations' } },
      { code: 'MATH 2B', name: 'Linear Algebra', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 18', name: 'Linear Algebra' } },
      { code: 'MATH 1B', name: 'Calculus II', units: 5.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'MATH 20B', name: 'Calculus for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/20E', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/20E', satisfies: { code: 'MATH 20C', name: 'Calculus and Analytic Geometry for Science and Engineering' } },
      { code: 'MATH 1C', name: 'Calculus III', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/20E', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } },
      { code: 'MATH 1D', name: 'Calculus IV', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'MATH 20C/20E', satisfies: { code: 'MATH 20E', name: 'Vector Calculus' } }
    ]
  }
];
