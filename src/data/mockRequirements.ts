...
export const mockRequirements: TransferRequirement[] = [
...

  {
    ...
    courses: [
      ...
      { code: 'MATH 1AH', name: 'Calculus I - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Math 51 Calculus I', satisfies: { code: 'MATH 51', name: 'Calculus I' } },
      ...
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Math 52 Calculus II', satisfies: { code: 'MATH 52', name: 'Calculus II' } },
      ...
      { code: 'MATH 1CH', name: 'Calculus III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Math 53 Multivariable Calculus', satisfies: { code: 'MATH 53', name: 'Multivariable Calculus' } },
      ...
      { code: 'MATH 2AH', name: 'Differential Equations - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Math 54 Linear Algebra and Differential Equations', satisfies: { code: 'MATH 54', name: 'Linear Algebra and Differential Equations' } },
      { code: 'MATH 2BH', name: 'Linear Algebra - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Math 54 Linear Algebra and Differential Equations', satisfies: { code: 'MATH 54', name: 'Linear Algebra and Differential Equations' } },
      { code: 'PHYS 4A', name: 'Physics for Scientists and Engineers: Mechanics', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYSICS 7A', name: 'Physics for Scientists and Engineers' } },
      { code: 'PHYS 4B', name: 'Physics for Scientists and Engineers: Electricity and Magnetism', units: 6.0, type: 'Required', category: 'MajorPrep', satisfies: { code: 'PHYSICS 7B', name: 'Physics for Scientists and Engineers' } },
      ...
      { code: 'ENGL C1000H', name: 'Academic Reading and Writing - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'Reading and Composition A', satisfies: { code: 'READING COMPOSITION A', name: 'Courses that satisfy Reading & Composition A' } },
      ...
      { code: 'ENGL C1001H', name: 'Critical Thinking and Writing - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'Reading and Composition B', satisfies: { code: 'READING COMPOSITION B', name: 'Courses that satisfy Reading & Composition B' } },
      ...
      { code: 'EWRT 1BH', name: 'Reading, Writing and Research - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'Reading and Composition B', satisfies: { code: 'READING COMPOSITION B', name: 'Courses that satisfy Reading & Composition B' } },
      ...
      { code: 'CHEM 1AH', name: 'General Chemistry I - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Required Chem/Physics Selection - Option 1: UCB CHEM 1B', satisfies: { code: 'CHEM 1B', name: 'General Chemistry' } },
      { code: 'CHEM 1BH', name: 'General Chemistry II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Required Chem/Physics Selection - Option 1: UCB CHEM 1B', satisfies: { code: 'CHEM 1B', name: 'General Chemistry' } },
      { code: 'CHEM 1CH', name: 'General Chemistry III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Required Chem/Physics Selection - Option 1: UCB CHEM 1B', satisfies: { code: 'CHEM 1B', name: 'General Chemistry' } },
      ...
      { code: 'MATH 22H', name: 'Discrete Mathematics - HONORS', units: 5.0, type: 'Highly Recommended', category: 'MajorPrep', orGroup: 'Strongly Recommended Discrete Mathematics', satisfies: { code: 'MATH 55', name: 'Discrete Mathematics' } },
      ...
      { code: 'CIS 22CH', name: 'Data Abstraction and Structures - HONORS', units: 4.5, type: 'Highly Recommended', category: 'MajorPrep', description: 'Must complete an additional university course after transfer to satisfy this requirement', orGroup: 'Strongly Recommended Elective - CS 61B Options', satisfies: { code: 'COMPSCI 61B', name: 'Data Structures' } },
      ...
      { code: 'ENGR 37', name: 'Introduction to Circuit Analysis', units: 5.0, type: 'Highly Recommended', category: 'MajorPrep', description: 'Must complete an additional university course after transfer to satisfy this requirement', orGroup: 'Strongly Recommended Elective - EECS 16A Options', satisfies: { code: 'EECS 16A', name: 'Designing Information Devices and Systems I' } },
      { code: 'MATH 2AH', name: 'Differential Equations - HONORS', units: 5.0, type: 'Highly Recommended', category: 'MajorPrep', description: 'Must complete an additional university course after transfer to satisfy this requirement', orGroup: 'Strongly Recommended Elective - EECS 16A Options', satisfies: { code: 'EECS 16A', name: 'Designing Information Devices and Systems I' } },
      { code: 'MATH 2BH', name: 'Linear Algebra - HONORS', units: 5.0, type: 'Highly Recommended', category: 'MajorPrep', description: 'Must complete an additional university course after transfer to satisfy this requirement', orGroup: 'Strongly Recommended Elective - EECS 16A Options', satisfies: { code: 'EECS 16A', name: 'Designing Information Devices and Systems I' } },
...

  {
    ...
    courses: [
      ...
      { code: 'CIS 22CH', name: 'Data Abstraction and Structures - HONORS', units: 4.5, type: 'Required', category: 'MajorPrep', orGroup: 'Introduction to Computer Science II', satisfies: { code: 'COM SCI 32', name: 'Introduction to Computer Science II' } },
      ...
      { code: 'MATH 1AH', name: 'Calculus I - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus I for MATH 31A', satisfies: { code: 'MATH 31A', name: 'Differential and Integral Calculus' } },
      ...
      { code: 'MATH 1CH', name: 'Calculus III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus II & III for MATH 31B (Option 2 of 4)', satisfies: { code: 'MATH 31B', name: 'Integration and Infinite Series' } },
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus II & III for MATH 31B (Option 3 of 4)', satisfies: { code: 'MATH 31B', name: 'Integration and Infinite Series' } },
      ...
      { code: 'MATH 1BH', name: 'Calculus II - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus II & III for MATH 31B (Option 4 of 4)', satisfies: { code: 'MATH 31B', name: 'Integration and Infinite Series' } },
      { code: 'MATH 1CH', name: 'Calculus III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus II & III for MATH 31B (Option 4 of 4)', satisfies: { code: 'MATH 31B', name: 'Integration and Infinite Series' } },
      ...
      { code: 'MATH 1CH', name: 'Calculus III - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus III for MATH 32A', satisfies: { code: 'MATH 32A', name: 'Calculus of Several Variables' } },
      ...
      { code: 'MATH 1DH', name: 'Calculus IV - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Calculus IV for MATH 32B', satisfies: { code: 'MATH 32B', name: 'Calculus of Several Variables' } },
      ...
      { code: 'MATH 2BH', name: 'Linear Algebra - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Linear Algebra for MATH 33A', satisfies: { code: 'MATH 33A', name: 'Linear Algebra and Applications' } },
      ...
      { code: 'MATH 2AH', name: 'Differential Equations - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Differential Equations for MATH 33B', satisfies: { code: 'MATH 33B', name: 'Differential Equations' } },
      ...
      { code: 'MATH 22H', name: 'Discrete Mathematics - HONORS', units: 5.0, type: 'Required', category: 'MajorPrep', orGroup: 'Discrete Mathematics for MATH 61', satisfies: { code: 'MATH 61', name: 'Introduction to Discrete Structures' } },
      ...
      { code: 'ENGL C1000H', name: 'Academic Reading and Writing - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'English Composition A', satisfies: { code: 'ENGCOMP 3', name: 'English Composition, Rhetoric, and Language' } },
      ...
      { code: 'EWRT 1BH', name: 'Reading, Writing and Research - HONORS', units: 5.0, type: 'Required', category: 'IGETC', orGroup: 'English Composition B', satisfies: { code: 'ENGCOMP 3', name: 'English Composition, Rhetoric, and Language' } },
